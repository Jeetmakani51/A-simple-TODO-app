...
function createTodoItem(todo,todoIndex){
    ...
    todoLI.innerHTML = ` <input type="checkbox" id="${todoId}">
            <label class = "custom-checkbox" for="${todoId}"> <!--when we will click on tick svg then the checkbox also be clicked automatically due to label containing "for" that references todo-1 which is a checkbox-->
